...
import { DeviceData, Image, ImageD, TenantData } from '../../../@core/data/data';
import { DataManagementService } from '../../../@core/service/data-management.service';

@Component({
  selector: 'ngx-operating-mode',
  templateUrl: './operating-mode.component.html',
  styleUrls: ['./operating-mode.component.scss']
})
export class OperatingModeComponent implements OnInit {
